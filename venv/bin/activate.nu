...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/paritie/python codes/Student_Authentication/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/paritie/python codes/Student_Authentication/venv/bin/deactivate.nu'
